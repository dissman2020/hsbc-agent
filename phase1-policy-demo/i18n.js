...
window.I18N = (function () {
  ...
  S['a1.svg.req']    = { zh: `业务控制要求`, en: `Business control requirements` };
  S['a1.svg.reqSub'] = { zh: `必须允许 · 拒绝 · 脱敏`, en: `Must allow · deny · mask` };
  S['a1.svg.dict']   = { zh: `业务词典`, en: `Business dictionary` };
  S['a1.svg.dictSub']= { zh: `主体 · 动作 · 资源 · 等级`, en: `Subject · action · resource · level` };
  S['a1.svg.s1']     = { zh: `① 标准化`, en: `① Normalise` };
  S['a1.svg.norm']   = { zh: `统一规则对象   r = ⟨S, A, R, C, E, O, P, V⟩`, en: `Unified rule object   r = ⟨S, A, R, C, E, O, P, V⟩` };
  S['a1.svg.normSub']= { zh: `业务要求由大模型初转 + 人工审核，与规则同构化后一起求解`, en: `Business requirements are first converted by an LLM + human-reviewed, then aligned with rules and solved together` };
  ...
  S['a1.svg.g5']     = { zh: `依赖`, en: `dependency` };
  S['a1.svg.s3']     = { zh: `③ SMT 求解`, en: `③ SMT solving` };
  S['a1.svg.tool']   = { zh: `工具：Z3`, en: `Tool: Z3` };
  S['a1.svg.d1']     = { zh: `冲突`, en: `Conflict` };
  S['a1.svg.d1s']    = { zh: `同一输入效果矛盾`, en: `Same input, contradictory effect` };
  S['a1.svg.d2']     = { zh: `不可达`, en: `Unreachable` };
  S['a1.svg.d2s']    = { zh: `条件矛盾或被覆盖`, en: `Contradictory or overridden condition` };
  S['a1.svg.d3']     = { zh: `覆盖缺口`, en: `Coverage gap` };
  S['a1.svg.d3s']    = { zh: `业务要求无规则覆盖`, en: `Business requirement with no rule coverage` };
  S['a1.svg.d4']     = { zh: `冗余覆盖`, en: `Redundant coverage` };
  S['a1.svg.d4s']    = { zh: `不改变最终决策结果`, en: `Does not change the final decision` };
  S['a1.svg.solve']  = { zh: `有解 → 缺陷成立，解 x 可直接用作见证输入；无解 → 该关系不成立`, en: `Satisfiable → the defect holds and solution x serves as a witness input; unsatisfiable → the relation does not hold` };
  S['a1.svg.s4']     = { zh: `④ 输出`, en: `④ Output` };
  S['a1.svg.o1']     = { zh: `缺陷类型与规则号`, en: `Defect type and rule ID` };
  S['a1.svg.o2']     = { zh: `具体触发条件`, en: `Specific triggering conditions` };
  ...
  S['a2.svg.traceSub'] = { zh: `一次完整执行轨迹`, en: `One complete execution trace` };
  ...
  S['a2.svg.ivSub']  = { zh: `只改这一个变量`, en: `Change only this one variable` };
  S['a2.svg.s1']     = { zh: `① 还原定位`, en: `① Restore & locate` };
  S['a2.svg.r1']     = { zh: `按 Trace 编号还原`, en: `Restore by Trace ID` };
  S['a2.svg.r2']     = { zh: `定位判断前检查点`, en: `Locate the checkpoint before the decision` };
  S['a2.svg.r3']     = { zh: `保存原始状态`, en: `Save the original state` };
  S['a2.svg.s2']     = { zh: `② 双轨对照`, en: `② Dual-track comparison` };
  S['a2.svg.s2s']    = { zh: `核心差异`, en: `Key difference` };
  S['a2.svg.f1']     = { zh: `事实执行 · 对照基线`, en: `Factual execution · baseline` };
  S['a2.svg.f1s']    = { zh: `原条件重放同一条 Trace`, en: `Replay the same Trace under original conditions` };
  S['a2.svg.f1t']    = { zh: `回答“当时为什么这样判”`, en: `Answers “why was it decided this way then”` };
  S['a2.svg.c1']     = { zh: `反事实执行 · 受控干预`, en: `Counterfactual execution · controlled intervention` };
  S['a2.svg.c1s']    = { zh: `do(变量 = 新值) 后重放`, en: `Replay after do(variable = new value)` };
  S['a2.svg.c1t']    = { zh: `隔离沙箱 · 禁止真实写库发信`, en: `Isolated sandbox · no real DB writes or emails` };
  S['a2.svg.s3']     = { zh: `③ 差分比较`, en: `③ Diff comparison` };
  ...
  S['a2.svg.d2s']    = { zh: `脱敏 · 审批是否变化`, en: `Do masking / approval change` };
  S['a2.svg.d3']     = { zh: `数据暴露`, en: `Data exposure` };
  S['a2.svg.d3s']    = { zh: `哪些字段新增暴露`, en: `Which fields become newly exposed` };
  S['a2.svg.s4']     = { zh: `④ 最小致因`, en: `④ Minimal cause` };
  S['a2.svg.min']    = { zh: `收缩变量取值，找出让结果翻转的最小条件组合，并定位到具体规则`, en: `Shrink variable values to find the smallest condition combination that flips the result, and locate the specific rule` };
  S['a2.svg.out']    = { zh: `输出`, en: `Output` };
  S['a2.svg.o1']     = { zh: `决策翻转`, en: `Decision flip` };
  S['a2.svg.o2']     = { zh: `约束变化`, en: `Constraint change` };
  S['a2.svg.o3']     = { zh: `暴露变化`, en: `Exposure change` };
  S['a2.svg.o4']     = { zh: `最小致因`, en: `Minimal cause` };
  S['a2.svg.o5']     = { zh: `证据对`, en: `Evidence pair` };
  S['a2.svg.o6']     = { zh: `回归用例`, en: `Regression cases` };
